  ...
  return (
    <ProtectedRoute>
      ...
      <div className=" flex items-center justify-center">
        <h1 className="p-2 text-7xl font-extrabold text-white text-center transition-all duration-300 ease-in-out">
          GLOBAL AFFAIRS
        </h1>
      </div>

      <main className="min-h-screen text-white">
        <section className="columns-1 sm:columns-2 md:columns-3 lg:columns-5 gap-4 p-4 [column-fill:_balance] border-y border-gray-800">
          {articles?.map((article) => (
            <a
              ...
              className="mb-4 break-inside-avoid p-4 bg-gray-700 bg-opacity-60 rounded-lg cursor-pointer w-full inline-block transform transition-transform duration-300 ease-in  hover:scale-102 hover:shadow-2xl"
            >

      ...
      <nav className={`w-full p-2 text-white border-b border-gray-700 bg-transparent ${className || ''}`}>
        ...
        <ul
          className={`w-full md:flex flex-col md:flex-row justify-center items-center md:space-x-6 space-y-2 md:space-y-0 whitespace-nowrap font-semibold mt-2 md:mt-0
            ${menuOpen ? 'flex' : 'hidden'} md:flex bg-gray-900 md:bg-transparent p-4 md:p-0 rounded-lg md:rounded-none z-50 absolute md:static left-0 right-0 top-14 md:top-auto`}
        >
          <li className={`inline-block ${activeLink === 'home' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}> 
          ...
          <li className={`inline-block relative group ${activeLink === 'committee-overview' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
          ...
          {role === 'chair' && (
            <li className={`inline-block ${activeLink === 'chair-tool' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
          ...
          {role === 'admin' ? (
            <li className={`inline-block ${activeLink === 'admin' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
            ...
            <>
              <li className={`inline-block ${activeLink === 'speechrepo' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
              ...
              <li className={`inline-block ${activeLink === 'glossary' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
              ...
              <li className={`inline-block ${activeLink === 'global-affairs' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
              ...
              <li className={`inline-block ${activeLink === 'resolutions' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
          ...
          <li className={`${activeLink === 'live-updates' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'} p-2 rounded-lg w-full md:w-auto`}>
